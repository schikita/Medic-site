...
function xr_default_institutions_blocks(): array
{
    ...
    return [
        ...
        [
            ...
            'props' => [
                ...
                'vip' => [
                    ...
                    'cta_label' => 'Start VIP Journey',
                    'cta_href' => '#',
                ],
                'priority' => [
                    'pill' => 'Be First. Get More.',
                    'title' => 'PRIORITY EXCLUSIVE',
                    'items' => [
                    ...
                    'cta_label' => 'Pre-Order Right Now',
                    'cta_href' => '#',
                ],
            ],
        ],
        [
            'type' => 'training_headline',
            'id' => 'i-3-16',
            'props' => [
                'theme' => 'light',
                'lines' => [
        ...
        [
            'type' => 'nextgen_hands_training',
            'id' => 'i-3-18',
            'props' => [
                'title_lines' => ['Next-Gen', 'Hands-On', 'Training'],
                'nav_items' => ['Hologram Library', 'Case Simulation', 'Test & Masterskills'],
                'card_heading' => 'Your Clinical Reality in AR/VR Glasses',
                'center_image' => $img('318hub', 360, 360),
                'center_label' => 'All-in-One',
                'center_brand' => 'XR DOCTOR',
                'modules' => [
                    ['label' => 'Digital Patient & On-Off Layers', 'image' => $img('318tl', 560, 400)],
                    ['label' => 'True-to-Life Organ Holograms', 'image' => $img('318tr', 560, 400)],
                    ['label' => 'Medical Equipment & Tools', 'image' => $img('318bl', 560, 400)],
                    ['label' => 'Patient Panel & Clinical Case Data', 'image' => $img('318br', 560, 400)],
                ],
            ],
        ],
        [
