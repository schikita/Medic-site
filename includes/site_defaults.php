...
function xr_default_home_blocks(): array
{
    ...
    return [
        ...
        [
            ...
            'id' => 'institutions',
            'props' => [
                'headline_line1' => 'Everything Changes',
                'headline_line2' => 'with XR Doctor',
                'tagline' => 'AI-powered XR Platform – tailored for your medical reality from hospitals to universities',
            ],
        ],
        [
            'type' => 'wave_slider',
            ...
            'props' => [
                'slides' => [
                    ['image' => $img('a', 1440, 720), 'caption' => 'Holographic clinical workspace'],
                    ['image' => $img('b', 1440, 720), 'caption' => 'Training in AR / VR'],
                    ['image' => $img('c', 1440, 720), 'caption' => 'Shared decision-making'],
                ],
                'interval_ms' => 5000,
            ],
        ],
        [
            ...
            'id' => 'block-1-3',
            'props' => [
                'title' => 'Spatial clarity for every case',
                'subtitle' => 'Layered holograms, real-time collaboration, mapped to your environment.',
                'base_color' => '#151a22',
            ],
        ],
        [
            ...
            'id' => 'block-1-4-5',
            'props' => [
                'heading' => 'See XR Doctor in motion',
                'tabs' => [
                    [
                        'label' => 'Product film',
                        'mode' => 'youtube_click',
                    ...
                    [
                        'label' => 'Loop preview A',
                        'mode' => 'video_loop',
                        'poster' => $img('e', 800, 500),
                        'mp4' => 'https://www.w3schools.com/html/mov_bbb.mp4',
                    ],
                    [
                        'label' => 'Loop preview B',
                        'mode' => 'video_loop',
    ...
    return [
        ...
        [
            ...
            'props' => [
                ...
                'tagline' => 'Masonry-style grid (4.2): one pinned post links to the full article in block 4.3. Cross-link from Home block 1.9 points here.',
            ],
        ],
        [
            'type' => 'blog_masonry',
    ...
    return [
        ...
        [
            ...
            'props' => [
                ...
                'tagline' => 'Block 5.2 — gradient headline block (same pattern as Home §1.2).',
            ],
        ],
        [
            'type' => 'white_planks',
